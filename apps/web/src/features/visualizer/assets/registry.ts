...
const typeAndFrames: StudioAssetDefinition[] = [
  ...
  },
  {
    ...
    category: 'typography',
    collection: 'type-frames',
    description: 'Tilted pill sticker — playful promo labels and callouts that pop off the stage.',
    tags: ['sticker', 'label', 'playful'],
    trigger: 'beat',
    pulseAmount: 0.2,
    extraEffect: 'shake',
    extraAmount: 0.1,
    settings: { visualKind: 'typography', typeKind: 'sticker', text: 'NEW DROP', color: '#ff4fd8' },
  },
  {
    id: 'speech-bubble',
    name: 'Speech Bubble',
    ...
    category: 'typography',
    collection: 'type-frames',
    description: 'Comic speech bubble — dialogue, quotes, and punchy one-liners with a tail.',
    tags: ['bubble', 'comic', 'dialogue'],
    trigger: 'vocals',
    pulseAmount: 0.16,
    extraEffect: 'float',
    extraAmount: 0.12,
    settings: { visualKind: 'typography', typeKind: 'bubble', text: 'HEY!', color: '#ffe14d' },
  },
  {
    id: 'caption-bar',
    name: 'Caption Bar',
    ...
    category: 'typography',
    collection: 'type-frames',
    description: 'Lower-third caption bar — documentary titles, credits, and scene labels.',
    tags: ['caption', 'lower-third', 'credits'],
    trigger: 'full',
    pulseAmount: 0.08,
    extraEffect: 'none',
    extraAmount: 0,
    settings: { visualKind: 'typography', typeKind: 'caption', text: 'directed by you', color: '#ffffff' },
  },
  {
    id: 'chrome-metal',
    name: 'Chrome Metal',
    ...
    category: 'typography',
    collection: 'type-frames',
    description: 'Polished chrome lettering — Y2K metal, luxury branding, and reflective headlines.',
    tags: ['chrome', 'metal', 'y2k'],
    trigger: 'highs',
    pulseAmount: 0.18,
    extraEffect: 'glow',
    extraAmount: 0.22,
    settings: { visualKind: 'typography', typeKind: 'chrome', text: 'CHROME', color: '#c8d4ff' },
  },
  {
    id: 'ransom-note',
    name: 'Ransom Note',
    ...
    category: 'typography',
    collection: 'type-frames',
    description: 'Cut-and-paste ransom collage — gritty zine energy and DIY punk aesthetics.',
    tags: ['ransom', 'zine', 'punk'],
    trigger: 'beat',
    pulseAmount: 0.12,
    extraEffect: 'shake',
    extraAmount: 0.14,
    settings: { visualKind: 'typography', typeKind: 'ransom', text: 'LISTEN UP', color: '#ffffff' },
  },
  {
    id: 'giant-number',
    name: 'Giant Number',
    ...
    category: 'typography',
    collection: 'type-frames',
    description: 'Oversized numeral — countdowns, track numbers, and bold stat callouts.',
    tags: ['number', 'countdown', 'stat'],
    trigger: 'bass',
    pulseAmount: 0.24,
    extraEffect: 'glow',
    extraAmount: 0.18,
    settings: { visualKind: 'typography', typeKind: 'number', text: '01', color: '#ffffff' },
  },
  {
    id: 'vertical-type',
    name: 'Vertical Type',
    ...
    category: 'typography',
    collection: 'type-frames',
    description: 'Vertical stacked lettering — Japanese poster vibes and editorial side titles.',
    tags: ['vertical', 'editorial', 'poster'],
    trigger: 'full',
    pulseAmount: 0.1,
    extraEffect: 'drift',
    extraAmount: 0.1,
    settings: { visualKind: 'typography', typeKind: 'vertical', text: 'VERTICAL', color: '#80ffdb' },
  },
  {
    id: 'outline-stroke',
    name: 'Outline Stroke',
    ...
    category: 'typography',
    collection: 'type-frames',
    description: 'Hollow outlined headline — sports broadcast, streetwear, and high-contrast titles.',
    tags: ['outline', 'stroke', 'bold'],
    trigger: 'vocals',
    pulseAmount: 0.16,
    extraEffect: 'glow',
    extraAmount: 0.14,
    settings: { visualKind: 'typography', typeKind: 'outline', text: 'OUTLINE', color: '#ffffff' },
  },
  {
    id: 'glitch-split',
    name: 'Glitch Split',
    ...
    category: 'typography',
    collection: 'type-frames',
    description: 'RGB chromatic split — digital distortion, VHS errors, and cyberpunk headlines.',
    tags: ['glitch', 'rgb', 'cyberpunk'],
    trigger: 'highs',
    pulseAmount: 0.14,
    extraEffect: 'flicker',
    extraAmount: 0.32,
    settings: { visualKind: 'typography', typeKind: 'glitch', text: 'GLITCH', color: '#ffffff' },
  },
  {
    id: 'holo-shimmer',
    name: 'Holo Shimmer',
    ...
    category: 'typography',
    collection: 'type-frames',
    description: 'Iridescent holographic fill — foil-card shimmer and festival poster gradients.',
    tags: ['holographic', 'shimmer', 'foil'],
    trigger: 'highs',
    pulseAmount: 0.2,
    extraEffect: 'glow',
    extraAmount: 0.28,
    settings: { visualKind: 'typography', typeKind: 'holo', text: 'SHIMMER', color: '#ff4fd8' },
  },
  {
    id: 'vhs-border',
    name: 'VHS Border',
