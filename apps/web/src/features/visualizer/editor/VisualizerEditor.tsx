...
import { computeOutputSize, DEFAULT_PRESET_ID, type ExportPreset, type PresetId } from '../export/presets'
...
export function VisualizerEditor() {
  ...
  const { prerenderStats, prerenderCacheRef } = usePrerenderCache({
    project,
    hasAudio,
    rendererMode,
    isPreparing,
